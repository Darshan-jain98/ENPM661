...
#Action to move left 30 degree wrt robot
def ActionMoveLeft30(Node_State_i,step_size):
    New_Node_State_i = np.copy(Node_State_i)
    New_Node_State_i[0] = Node_State_i[0] + round((step_size*cos(radians(Node_State_i[2] + 30)))+0.5)
    New_Node_State_i[1] = Node_State_i[1] + round((step_size*sin(radians(Node_State_i[2] + 30)))+0.5)
...
#Action to move left 60 degree wrt robot
def ActionMoveLeft60(Node_State_i,step_size):
    New_Node_State_i = np.copy(Node_State_i)
    New_Node_State_i[0] = Node_State_i[0] + round((step_size*cos(radians(Node_State_i[2] + 60)))+0.5)
    New_Node_State_i[1] = Node_State_i[1] + round((step_size*sin(radians(Node_State_i[2] + 60)))+0.5)
...
#Action to move straight wrt robot
def ActionMoveForward(Node_State_i,step_size):
    New_Node_State_i = np.copy(Node_State_i)
    New_Node_State_i[0] = Node_State_i[0] + round((step_size*cos(radians(Node_State_i[2])))+0.5)
    New_Node_State_i[1] = Node_State_i[1] + round((step_size*sin(radians(Node_State_i[2])))+0.5)
...
#Action to move right 30 degree wrt robot
...
# Function to calculate the distance from goal node for cost to go calculation
def distance(Node1,Node2):
    return round(sqrt((Node1[0]-Node2[0])**2 + (Node1[1]-Node2[1])**2))


# Function to check if the current node is within the threshold of the goal node
...
# function to create the back track list
...
# loop to input the correct input for the start and goal node
while True:
...
#Loop to visualize the final path
